$(function () {
		    ...
		    $("#appDate3").val('').scroller('destroy').scroller($.extend(opt['date'], opt['default']));
		  	var optDateTime3 = $.extend(opt['datetime'], opt['default']);
		  	var optTime3 = $.extend(opt['time'], opt['default']);
		    $("#appDateTime3").mobiscroll(optDateTime3).datetime(optDateTime3);
		    $("#appTime3").mobiscroll(optTime3).time(optTime3);	
